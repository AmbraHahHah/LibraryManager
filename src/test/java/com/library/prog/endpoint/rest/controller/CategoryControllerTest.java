...
class CategoryControllerTest extends FacadeIT {
  ...
  void list_all_categories() {
    rest.postForEntity(
        "/categories", CategoryRequest.builder().name("Fiction").build(), CategoryResponse.class);
    rest.postForEntity(
        "/categories",
        CategoryRequest.builder().name("Non-Fiction").build(),
  ...
  void create_hierarchical_category() {
    var parent =
        rest.postForEntity(
            "/categories",
            CategoryRequest.builder().name("Parent").build(),
            CategoryResponse.class);
    var childRequest =
  ...
  void find_root_categories() {
    rest.postForEntity(
        "/categories", CategoryRequest.builder().name("Root").build(), CategoryResponse.class);
  ...
  void update_category() {
    var created =
        rest.postForEntity(
            "/categories",
            CategoryRequest.builder().name("Original").build(),
            CategoryResponse.class);
    ...
    var updated =
        rest.getForEntity("/categories/" + created.getBody().id(), CategoryResponse.class);
  ...
  void delete_category() {
    var created =
        rest.postForEntity(
            "/categories",
            CategoryRequest.builder().name("To Delete").build(),
            CategoryResponse.class);
